...
import Triple from "../assets/tripple.png";
      ...
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8">
        ...
        <div className="w-full shadow-xl flex flex-col p-4  my-4 rounded-lg hover:scale-105 duration-300">
          ...
          <div className="text-center font-medium">
            ...
            <p className="py-2 border-b mx-8">1 GB Granted user</p>
        ...
        <div className="w-full shadow-xl bg-gray-100 flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300">
          ...
          <div className="text-center font-medium">
            ...
            <p className="py-2 border-b mx-8">3 GB Granted user</p>
            <p className="py-2 border-b mx-8">Send upto 5GB</p>
          </div>
          <button className="bg-[#1f2020] w-[200px] rounded-md font-medium my-6 mx-auto py-3 text-bold text-[#00df9a]">
            Start Trial
          </button>
        </div>
        {/* Triple */}
        <div className="w-full shadow-xl flex flex-col p-4  my-4 rounded-lg hover:scale-105 duration-300">
          ...
          <div className="text-center font-medium">
            ...
            <p className="py-2 border-b mx-8">5 GB Granted user</p>
